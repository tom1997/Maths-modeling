...
针对问题一，采用几何关系法，根据每个角度所投射的图像与其建立关系方程式
...
\begin{tabular}{|c|c|}
 ...
 S	    & 探测器之间的距离（mm） \\ \hline
 $\theta_i$	    & 初始方向到第i次逆时针旋转的逆时针角度（$^\circ$）  \\ \hline
...
针对问题一，首先确定每个探测器单元之间的距离，再建立一个坐标系确定圆与射线的相对关系，根据题目所给的吸收率，求出衰减系数。假设吸收率与每一条X射线穿过的介质厚度是呈线性关系的，利用几何关系法，利用探测器单元的距离差算出，就可以求出每一次转动的角度。而针对
\begin{equation}
\int^5_2xdx=2
\end{equation}
